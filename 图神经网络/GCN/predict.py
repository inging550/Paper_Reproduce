...
img_root = "picture.jpg"  # 需要预测的图片路径
net = GCN().to(device)  # 给神经网络实例化对象
net.load_state_dict(torch.load("GCN.pth"))  # 导入权重参数
net.eval()
...
if __name__ == "__main__":
    ...
    for index, data in enumerate(test_loader):
        ...
        labels_np = data.y.numpy()  # array([0,5,0,6,2,...],dtype=int64)
